...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 ml-2 mr-2" style="max-width:100%;">
            ...
            @endif
            <div class="card" style="min-width: 600px!important; margin-left: auto!important; margin-right: auto!important;">
                <div class="card-header">All food</div>

                <div class="card-body">
                    <table class="table ml-0 mr-0" style="min-width:200px;">
                        <thead class="thead-dark" style="min-width:200px;">
                            <tr style="min-width:200px; vertical-align: middle!important;">
                        ...
                        <tbody style="min-width:200px;">
                            ...
                            <tr style="min-width:200px;">
                                ...
                                <td  style="vertical-align: middle!important;">{{$food->description}}</td>
                                <td  style="vertical-align: middle!important;">${{$food->price}}</td>
                                <td  style="vertical-align: middle!important;">{{$food->category->name}}</td>
                                <td  style="vertical-align: middle!important;">
                                    <a style="display: inline" href="{{route('food.edit'
                                    ,[$food->id])}}">
